...
from ukgeo.ore_image_overlay import _overlay_placement, apply_ore_image_overlay
...
def test_overlay_placement_preserves_source_aspect_ratio():
    scale, offset_x, offset_z = _overlay_placement(900, 1044, 650_000, 1_300_000, "cover")

    assert scale == 1_300_000 / 1044
    assert offset_x < 0
    assert offset_z == 0
